const InfoAlert = ({title,description}) => {
  return (
    <div className="py-5 w-full bg-white dark:bg-dark">
      <div className="container">
        <div className="shadow-1 bg-blue-100  flex w-full rounded-lg border-l-[6px] border-transparent px-7 py-5">
          ...
          <div className="w-full">
            <h5 className="mb-1 text-lg font-semibold text-cyan-dark">
              {title}
            </h5>
